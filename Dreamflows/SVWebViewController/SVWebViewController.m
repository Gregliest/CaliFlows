...
@property (nonatomic, strong) NSString *cachedWebPage;

@property (nonatomic)int networkActivityCounter;
...
- (void)loadView {
    ...
    [mainWebView loadHTMLString:self.cachedWebPage baseURL:nil];
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    //Make sure that it gets rid of all of the count that it is responsible for
    //NSLog(@"Outstanding network activity threads: %d", self.networkActivityCounter);
    for (int i = 0; i < self.networkActivityCounter; i++) {
